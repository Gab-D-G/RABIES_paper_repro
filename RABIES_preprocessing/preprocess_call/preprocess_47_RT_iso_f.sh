...
singularity run -B /scratch/m/mchakrav/desgab/data/multicenter/inputs/47_RT_iso_f:/nii_inputs:ro \
-B /scratch/m/mchakrav/desgab/data_preprocess/multicenter/rabies_47_RT_iso_f_20221024:/rabies_out \
