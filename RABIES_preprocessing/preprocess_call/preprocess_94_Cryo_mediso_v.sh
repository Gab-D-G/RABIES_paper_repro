...
singularity run -B /scratch/m/mchakrav/desgab/data/multicenter/inputs/94_Cryo_mediso_v:/nii_inputs:ro \
-B /scratch/m/mchakrav/desgab/data_preprocess/multicenter/rabies_94_Cryo_mediso_v_20221024:/rabies_out \
