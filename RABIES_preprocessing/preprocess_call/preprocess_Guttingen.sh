...
singularity run -B /scratch/m/mchakrav/desgab/rats/ds001981_inputs:/nii_inputs:ro \
-B /scratch/m/mchakrav/desgab/rats/rabies_ds001981_inputs_20211026:/rabies_out \
...
--labels /atlases/Fischer344_nii_v4/Fischer344_template_labels.nii
