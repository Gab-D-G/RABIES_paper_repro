...
singularity run -B /scratch/m/mchakrav/desgab/data/multicenter/inputs/94_RT_mediso_f1:/nii_inputs:ro \
-B /scratch/m/mchakrav/desgab/data_preprocess/multicenter/rabies_94_RT_mediso_f1_20221024:/rabies_out \
