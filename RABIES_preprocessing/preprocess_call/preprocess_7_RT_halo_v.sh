...
singularity run -B /scratch/m/mchakrav/desgab/data/multicenter/inputs/7_RT_halo_v:/nii_inputs:ro \
-B /scratch/m/mchakrav/desgab/data_preprocess/multicenter/rabies_7_RT_halo_v_20221024:/rabies_out \
