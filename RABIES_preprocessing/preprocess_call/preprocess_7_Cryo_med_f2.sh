...
singularity run -B /scratch/m/mchakrav/desgab/data/multicenter/inputs/7_Cryo_med_f2:/nii_inputs:ro \
-B /scratch/m/mchakrav/desgab/data_preprocess/multicenter/rabies_7_Cryo_med_f2_20221024:/rabies_out \
