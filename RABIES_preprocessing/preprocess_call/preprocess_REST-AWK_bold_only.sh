...
-B /scratch/m/mchakrav/desgab/data_preprocess/rabies_bids_grandjean_rest_awk_bold_only_subset_20221024:/rabies_out \
/home/m/mchakrav/desgab/singularity_images/rabies-0.4.7.sif -p MultiProc preprocess /nii_inputs /rabies_out \
